...
class ActivityNet_Caption_DataLoader_Flow_Pickle(Dataset):
    ...
    def _get_audio(self, choice_audio_ids):
        ...
        for i, audio_id in enumerate(choice_audio_ids):
            try:
                ...
                try:
                    audio_slice = self.a_feature_dict[audio_id.replace("v_", "")]
                except:
...
if __name__ == "__main__":
    ...
    dataset = ActivityNet_Caption_DataLoader_Flow_Pickle(
