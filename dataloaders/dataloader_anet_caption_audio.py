...
class ActivityNet_Caption_DataLoader_Audio(Dataset):
    ...
    def __init__(
        ...
        try:
            ...
            self.v_feature_size = self.v_feature_dict[self.annotations[0].replace("v_","")].shape[-1]
            
        try:
            self.a_feature_size = self.a_feature_dict[self.annotations[0]].shape[-1]
        except:
            self.a_feature_size = self.a_feature_dict[self.annotations[0].replace("v_", "")].shape[-1]
...
if __name__ == "__main__":
    ...
    dataset = ActivityNet_Caption_DataLoader_Audio(
        annotations_path="/4TBssd/collaborative-experts/data/anet_caption/val_ids.json",
        v_features_path="/4TBssd/collaborative-experts/data/anet_caption/anet_caption_tsp.pkl",
        a_features_path="/4TBssd/collaborative-experts/data/activity_net/data/activity-net/structured-symlinks/aggregated_audio/vggish-audio-raw.pickle",
        json_path="/4TBssd/collaborative-experts/data/anet_caption/val_2.json",
        tokenizer=tokenizer,
        max_words=30,
        feature_framerate=1.0,
        max_frames=100,
