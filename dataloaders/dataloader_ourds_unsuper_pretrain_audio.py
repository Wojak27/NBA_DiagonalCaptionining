...
class OURDS_PreTrainAudio_DataLoader(Dataset):
    ...
    def _get_audio(self, choice_audio_ids):
        ...
        audio = np.zeros((len(choice_audio_ids), self.max_frames, 128))
        ...
        n_tokens = int(self.max_frames*(1-self.mask_prob))
        trimmed_audio = np.zeros((len(choice_audio_ids), n_tokens, 128))
