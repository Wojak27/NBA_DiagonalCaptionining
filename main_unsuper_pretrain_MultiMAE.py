...
if __name__ == "__main__":
    ...
    args = Args_Caption(features_dir="data", do_eval=False, task="unsup-pretrain-audio", output_dir="MAEpretrained_models/out_pretrain_{}e_{}c_{}d_audio_extra_scaled_1_5_MultiMAE{}_{}BS{}".format(encL, crossL, decL,"_fullcross" if fullcross else "", BS, "" if diag_masking else "_nodiag"))
    args.mask_prob = 0.85
    args.load_checkpoint = False
    args.batch_size_val = 32
    args.bottleneck_dim = None
    args.decoder_num_hidden_layers = decL
    args.visual_num_hidden_layers = encL
    ...
    args.cross_num_hidden_layers = crossL
