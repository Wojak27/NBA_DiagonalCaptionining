        ...
        for epoch in range(args.epochs):
            ...
            if args.local_rank == 0:
                ...
                if epoch > 2:
                    ...
                    if (best_score == None or average_improvement > 0) and epoch > 2:
                        best_score = Scores
...
class Args_Caption:
    def __init__(self, data_dir="data", features_dir="features", do_eval=True, task="caption", output_dir="output", export_attention_scores=False):
        ...
        self.data_path = "{}/ourds_description_only.json".format(self.data_dir)
        ...
        # self.init_model = "{}/MAEpretrained_models/out_pretrain_6e_3c_1d_audio_extra_scaled_1_5_MultiMAE_fullcross_128BS_nodiag/pytorch_model.bin.pretrain.100".format(os.environ["DIR_PATH"])
        # self.init_model = "{}/MAEpretrained_models/out_pretrain_6e_0b_3c_1d_audio_kinetics_scaled_90prob_3_mEncL_896bs/pytorch_model.bin.pretrain.100".format("/4TBssd/NSVA_pre_trained_models")
        # self.init_model = "{}/MAEpretrained_models/out_pretrain_6e_0b_3c_1d_audio_kinetics_scaled_90prob_3_mEncL_896bs/pytorch_model.bin.pretrain.200".format("/4TBssd/NSVA_pre_trained_models")
        # self.init_model = "{}/MAEpretrained_models/out_pretrain_6e_0b_3c_1d_audio_kinetics_896bs/pytorch_model.bin.pretrain.200".format("/4TBssd/NSVA_pre_trained_models")
        # self.init_model = "{}/MAEpretrained_models/out_pretrain_6e_3c_1d_audio_extra_scaled_1_5_Prob0.9_128BS/pytorch_model.bin.pretrain.200".format("/4TBssd/NSVA_pre_trained_models")
        # self.init_model = "{}/MAEpretrained_models/out_pretrain_6e_6c_1d_audio_extra_scaled_1_5_Prob90_128BS_nodiag/pytorch_model.bin.pretrain.200".format("/4TBssd/NSVA_pre_trained_models")
        self.init_model = "{}/weight/univl.pretrained.bin".format(".")
        # self.init_model = "{}/Finetuned_models/ourds_nodiag_lang/pytorch_model.bin.0".format(".")
        ...
        self.task_type = task # caption, unsup-pretrain
        self.datatype = "ourds-QA" # youcook, msrvtt, ourds, ourds-audio-bbx, anet, anet_c3d, anet_c3d_flow,outds-lang
        self.world_size = 0
        self.local_rank = 0
        self.coef_lr = 0.1
        self.use_mil = False
...
if __name__ == "__main__":
    ...
    args = Args_Caption(features_dir="data", do_eval=False, output_dir="Finetuned_models/ourds_nodiag_lang", export_attention_scores=False, task="caption-knowledge")
