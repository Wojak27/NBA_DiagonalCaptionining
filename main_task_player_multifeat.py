...
if __name__ == "__main__":
    ...
    args = Args_Caption(features_dir="data", do_eval=False, output_dir="Finetuned_models/3e6c3c_kinetics", export_attention_scores=False)
